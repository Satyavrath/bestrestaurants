...
//  BestRestaurants
//
//  Created by Injamuri,Satyavrath on 3/5/19.
...
class NewRestaurantViewController: UIViewController {
    ...
    @IBAction func done(_ sender: Any){
        ...
        Restaurants.shared.add(restaurant: Restaurant(name: name,  genre: .sandwiches, rating: Int(rating)!))
